...
Print a retangle to test alignment.
With this example you can see the printer behavior, if alignment  is  ok  and
distance of pixels are correct. With this sketch you can see how many time is
needed to do alignment of column and line and you can adjust the servo time too.
...
void setup(){
  ...
  char firstLine[]  = {"11000000000000000011"};
  char secondLine[] = {"11111111111111111111"};
   ...
   */
  printer.writeLine(secondLine);
  for (int i=0; i<10;i++){
      printer.writeLine(firstLine);
  }
  printer.writeLine(secondLine);
}
